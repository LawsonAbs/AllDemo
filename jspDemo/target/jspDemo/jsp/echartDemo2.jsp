...
<div id="content" style="height:100%; width:100%;display: table;">
    ...
    <div id="left" style="background: #99B898; width:40%; height:100%; position:relative;top:0;left: 0; display:table-cell;">
    ...
    <div id="right" style="height:100%; width:70%; position: relative;display: table-cell;">
        ...
        <div id="bottom" style="background: #FFFFFF; height: 420px; position: absolute;top:490px;width: 50%;">
            <div id="bottomLeft" style="position: absolute;height:100%;width:90% ">            </div>
            <!--width:90%  指的是在父框架的基础上的90%-->
            <div id="bottomRight" style="position: absolute; left: 552px; height:100%;width: 90%;">            </div>
        </div>
    </div>
