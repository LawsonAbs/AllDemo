package mapReduce.fromHBToMys.teleDuration;
...
public class HBStatJob {
    ...
    public static String[] fieldNames = {"teleNumber","callDuration"};
    ...
    public static void main(String[] args) {
        try {
            ...
            job.setJarByClass(HBStatJob.class);
