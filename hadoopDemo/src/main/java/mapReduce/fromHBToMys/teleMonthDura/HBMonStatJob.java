package mapReduce.fromHBToMys.teleMonthDura;
...
public class HBMonStatJob {
    /**
     * fieldNames: table's field Name
     */
    public static String hbaseTableName = "ns_ct:calllog";
    public static String familyName = "f1";
    public static String mysqlTableName = "monthStat";
    public static String[] fieldNames = {"teleNumber","yearMonth","callDuration"};
    ...
    public static void main(String[] args) {
        try {
            ...
            job.setJarByClass(HBMonStatJob.class);
