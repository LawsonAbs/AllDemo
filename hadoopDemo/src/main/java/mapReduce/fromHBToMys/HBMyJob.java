...
public class HBMyJob  {
    /**
     * fieldNames: table's field Name
     */
    public static String hbaseTableName = "telecom";
    public static String familyName = "cf" ;
    public static String mysqlTableName = "statistics";
    public static String[] fieldNames = {"id","teleNumber","yearMonth","callDuration"};
    ...
    public static void main(String[] args) {
        try {
            ...
            job.setJarByClass(HBMyJob.class);
